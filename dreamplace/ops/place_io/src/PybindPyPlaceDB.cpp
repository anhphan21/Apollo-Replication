...
void bind_PyPlaceDB(pybind11::module& m) 
{
    pybind11::class_<DREAMPLACE_NAMESPACE::PyPlaceDB>(m, "PyPlaceDB")
        ...
        .def_readwrite("node_num_ports_0", &DREAMPLACE_NAMESPACE::PyPlaceDB::node_num_ports_0)
        .def_readwrite("node_num_ports_90", &DREAMPLACE_NAMESPACE::PyPlaceDB::node_num_ports_90)
        .def_readwrite("node_num_ports_180", &DREAMPLACE_NAMESPACE::PyPlaceDB::node_num_ports_180)
        .def_readwrite("node_num_ports_270", &DREAMPLACE_NAMESPACE::PyPlaceDB::node_num_ports_270)
