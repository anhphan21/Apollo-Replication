...
void bind_PyPlaceDB(pybind11::module& m) 
{
    pybind11::class_<DREAMPLACE_NAMESPACE::PyPlaceDB>(m, "PyPlaceDB")
        ...
        .def_readwrite("pin_dir_x", &DREAMPLACE_NAMESPACE::PyPlaceDB::pin_dir_x)
        .def_readwrite("pin_dir_y", &DREAMPLACE_NAMESPACE::PyPlaceDB::pin_dir_y)
        .def_readwrite("pin_side", &DREAMPLACE_NAMESPACE::PyPlaceDB::pin_side)
        .def_readwrite("node_num_ports_left", &DREAMPLACE_NAMESPACE::PyPlaceDB::node_num_ports_left)
        .def_readwrite("node_num_ports_right", &DREAMPLACE_NAMESPACE::PyPlaceDB::node_num_ports_right)
        .def_readwrite("node_num_ports_lower", &DREAMPLACE_NAMESPACE::PyPlaceDB::node_num_ports_lower)
        .def_readwrite("node_num_ports_upper", &DREAMPLACE_NAMESPACE::PyPlaceDB::node_num_ports_upper)
        ...
        .def_readwrite("num_constraints", &DREAMPLACE_NAMESPACE::PyPlaceDB::num_constraints)
        .def_readwrite("constraint_names", &DREAMPLACE_NAMESPACE::PyPlaceDB::constraint_names)
        .def_readwrite("constraint_types", &DREAMPLACE_NAMESPACE::PyPlaceDB::constraint_types)
        .def_readwrite("constraint_settings", &DREAMPLACE_NAMESPACE::PyPlaceDB::constraint_settings)
        .def_readwrite("constraint_objects", &DREAMPLACE_NAMESPACE::PyPlaceDB::constraint_objects)
        .def_readwrite("flat_constraint_objects", &DREAMPLACE_NAMESPACE::PyPlaceDB::flat_constraint_objects)
        .def_readwrite("flat_constraint_objects_start", &DREAMPLACE_NAMESPACE::PyPlaceDB::flat_constraint_objects_start)
